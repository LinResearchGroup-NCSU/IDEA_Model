...
sys.path.append('/Users/xl23/Working/future/protein_DNA_interaction_optimization/code')
...
evaluate_phis_over_training_set("proteins_list.txt", "phi1_list.txt", decoy_method='complex_randomization', 
                                max_decoys=100000, tm_only=False, num_processors=1, TCRmodeling=True, TCR_name='TCR_NAME')
